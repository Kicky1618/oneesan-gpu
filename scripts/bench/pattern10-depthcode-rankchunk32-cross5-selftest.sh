...
case "$RANKSTREAM_LUT_LOAD" in constant) P10DC_RANKSTREAM_LUT_LDG=0 ;; ldg) P10DC_RANKSTREAM_LUT_LDG=1 ;; *) echo "RANKSTREAM_LUT_LOAD must be constant or ldg" >&2; exit 2;; esac
