...
scripts=(
  ...
  gen-b300-low-drop-chunk.py gen-b300-low-block-cache.py
...
echo "b300-exact-transform-chain-proof OK default_chain=1 high_chunk_composition=$high python_syntax=1 shell_syntax=1 gpu_required=0"
