#!/usr/bin/env python3
"""A/B entrypoint isolating v0.20 HIGH-closure row-depth body pruning."""
...
base.VARIANTS.update(
    {
        ...
        "v0.20": "src/cuda/b300/oneesan_cuda_gridfp_b300_hbm32_maskshard_blockorbit_compactaux_fullclosure_highrowpack16_lazyblockinit_rowdepthexact_tightlaunch_rowdepthorbit_rowcaplaunch_exacttasks_highclosurerowdepth_batch_guarded.cu",
    }
)

if "--variants" not in sys.argv[1:]:
    sys.argv[1:1] = ["--variants", "v0.19", "v0.20"]
