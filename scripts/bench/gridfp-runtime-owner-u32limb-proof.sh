...
grep -Fq 'max_magic=9757 max_magic_bits=14 max_shift=52 max_upper=8372291 max_upper_bits=23' <<<"$out"
grep -Fq 'table_entries=11 table_bytes=44 mul64_general=0 clamp_required=0 exact=1' <<<"$out"
echo 'gridfp-runtime-owner-u32limb-proof OK exact=1' >&2
