...
grep -Fq 'pack_exact=1 unpack_exact=1 direct_block_exact=1' <<<"$out"
echo 'rankchunk32-warpbase-proof OK pack_cases=4782969 chunk_bits=23 prefix_bits=9 block=32 height_padding_entries=0 max_block_base_loads_per_warp=2' >&2
