#!/usr/bin/env python3
"""A/B entrypoint isolating v0.55's CUDA Graph LOW row replay."""
...
base.VARIANTS.update({
    ...
    "v0.55": "src/cuda/b300/oneesan_b300_maskshard_v055_lowmaskbatch_ranges_graph.cu",
})
base.PHASE_KEYS = (
    "setup_s",
    "wall_s",
...
if "--variants" not in sys.argv[1:]:
    sys.argv[1:1] = ["--variants", "v0.54", "v0.55"]
