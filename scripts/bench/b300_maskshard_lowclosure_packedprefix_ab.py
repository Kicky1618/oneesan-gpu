#!/usr/bin/env python3
"""A/B entrypoint isolating v0.41 prepacked LOW closure prefixes."""
...
base.VARIANTS.update(
    {
        ...
        "v0.41": "src/cuda/b300/oneesan_b300_maskshard_v041_lowclosure_packedprefix.cu",
    }
)

if "--variants" not in sys.argv[1:]:
    sys.argv[1:1] = ["--variants", "v0.40", "v0.41"]
