...
print('runtime_edgecache_extra_shared_bytes_per_block=2560')
print('runtime_edgecache_packed_bytes_per_term=1')
print('runtime_edgecache_destination_bits=5')
print('runtime_edgecache_coefficient_bits=2')
print('runtime_edgecache_coefficient_range=-1..2')
