...
modes=(base metaptr metaarg intervals workerbind bundle persistent concurrent);declare -A build bin
build[base]=b300-hbm32-vmm-static-lpt-stagedmeta.sh;build[metaptr]=b300-hbm32-vmm-static-lpt-metaptr.sh;build[metaarg]=b300-hbm32-vmm-static-lpt-metakernelarg.sh;build[intervals]=b300-hbm32-vmm-static-lpt-staged-intervals.sh;build[workerbind]=b300-hbm32-vmm-static-lpt-workerbind.sh;build[bundle]=b300-hbm32-vmm-static-lpt-control-bundle.sh;build[persistent]=b300-hbm32-vmm-static-lpt-persistent-workers.sh;build[concurrent]=b300-hbm32-vmm-static-lpt-persistent-concurrent.sh
