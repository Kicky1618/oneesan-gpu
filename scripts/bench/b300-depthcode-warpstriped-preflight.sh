...
PM_ACCUM=0 DECODE_LOAD=ldg RANKSTREAM_LUT_LOAD=ldg RANKCHUNK32_ALIGN32=1 RUN_LAYOUT_PROOF=0 \
  ARCH="$ARCH" W=10 bash "$ONEESAN_ROOT/scripts/bench/pattern10-depthcode-rankchunk32-cross5-selftest.sh"
