...
print(f'runtime_discovery_validity_wall_speedup={old/new:.6f}x'); print(f'runtime_discovery_validity_wall_delta_pct={(new/old-1)*100:.4f}%'); print('runtime_discovery_simple_inverse_validity_scan=removed'); print('runtime_discovery_insert_n_validity_scan=removed'); print('runtime_discovery_rl_validity=two_popcounts'); print('runtime_discovery_ll_rr_validity=full_scan'); print('runtime_discovery_compressed_blocked_validity=full_scan'); print(f'summary={dst}')
PY
