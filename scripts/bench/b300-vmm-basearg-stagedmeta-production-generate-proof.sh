...
echo "b300-vmm-basearg-stagedmeta-production-generate-proof OK group_meta_bytes=13936 staged_h2d_once=1 per_group_meta_copy=D2D_sync host_meta_rebuild_per_group=0 staged_device_copy=1 default_stage_cap_mib=512 stage_within_hbm_reserve=1 expected_default_groups=16384 expected_default_mib_per_gpu=217.75 expected_old_meta_h2d_gib=5.9541015625 expected_staged_total_h2d_gib=1.701171875 h2d_reduction=3.5x"
