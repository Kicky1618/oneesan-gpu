#!/usr/bin/env python3
"""A/B entrypoint isolating v0.13 lazy BLOCKED scratch initialization."""
...
base.VARIANTS.update(
    {
        ...
        "v0.13": "src/cuda/b300/oneesan_cuda_gridfp_b300_hbm32_maskshard_blockorbit_compactaux_fullclosure_highrowpack16_lazyblockinit_batch_guarded.cu",
    }
)

if "--variants" not in sys.argv[1:]:
    sys.argv[1:1] = ["--variants", "v0.12", "v0.13"]
