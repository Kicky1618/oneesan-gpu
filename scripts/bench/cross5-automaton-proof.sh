...
grep -Fq 'candidate_mask_exact=1 state_exact=1 halt_exact=1 metadata_per_orbit=0 compact_state_delta=1' <<<"$out"
echo 'cross5-automaton-proof OK table_bytes=6561 old_table_bytes=15552 max_chunks=3 metadata_per_orbit=0' >&2
