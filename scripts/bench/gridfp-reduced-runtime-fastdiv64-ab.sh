...
print('runtime_fastdiv64_scope=all_runtime_component_label_divmods')
print('runtime_fastdiv64_removed_dynamic_divmod_pairs_per_label=2')
print('runtime_fastdiv64_dynamic_label_divmod_pairs_remaining=0')
print('runtime_fastdiv64_primitive_magic_entries=29')
print('runtime_fastdiv64_owner_group_magic_entries=154')
print('runtime_fastdiv64_turn_compress_group_magic_entries=154')
print('runtime_fastdiv64_group_magic_bytes_total=2464')
