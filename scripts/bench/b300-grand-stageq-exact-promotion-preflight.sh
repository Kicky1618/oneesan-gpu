...
echo 'b300-grand-stageq-exact-promotion-preflight OK legacy_schema3=1 stageq_requires_stagen=1 maximal_upstream=P,O,N tuple_change_required=1 summary_match=1 manifest_gate=1 rejection_before_promoter=1 gpu_work=0'
