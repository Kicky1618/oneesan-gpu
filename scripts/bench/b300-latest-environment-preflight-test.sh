...
grep -Fq 'b300_latest_preflight=OK' "$tmp/good.out" || { cat "$tmp/good.out" >&2; exit 3; }
...
echo 'b300-latest-environment-preflight-test OK good=1 vram_fail_closed=1 p2p_fail_closed=1 p2p_override=1 gpu_work=0'
