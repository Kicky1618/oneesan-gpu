...
echo "rankformula-nometa4-abstract-preflight OK w=$W n=$N metadata_bytes_per_code=0 exact_modes=b4_scalar,b8_scalar,b8_warpshare,b8_coopgroup,b16_coop_unrolled,b16_coop_rolled,b16_coop_rolled_select8,b16_coop_rolled_select8_srcpack10,b16_coop_rolled_depth4_srcpack10,b16_coop_rolled_group56_depth4_srcpack10 packed_group64_bits=59 group56_pack_bits=56 group56_abstract_off_bits=13 group56_self_group_index_bits=0 group56_off_device_loads=0 support_positions_runtime=0 b16_aux_bytes_all=707406 b16_coopgroup_table_loads_model=215509 b16_avg_early_ballots=2.251382 base_abstract_lut_bytes=94206 depth4_srcpack10_lut_bytes=86058 group56_depth4_srcpack10_device_lut_bytes=85578 depth4_table_bytes=28240 srcpack10_source_bytes=57338 srcpack10_dynamic_source_bytes=7668848 compact_e2e_proof=1 compact_production_selected=2492769 depth14_15_fast_zero=1 ballot_runtime_loads=0 build_smoke_b16_rolled_group56=$RUN_BUILD_SMOKE" >&2
