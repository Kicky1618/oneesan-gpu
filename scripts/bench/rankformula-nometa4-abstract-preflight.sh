...
echo "rankformula-nometa4-abstract-preflight OK w=$W n=$N metadata_bytes_per_code=0 block=4 packed_group64=1 support_positions_runtime=0 group_table_bytes_all=1158104 abstract_lut_bytes=94206 ballot_runtime_loads=0 lazy_source_loads=1 build_smoke=$RUN_BUILD_SMOKE" >&2
