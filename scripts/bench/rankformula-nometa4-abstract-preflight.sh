...
echo "rankformula-nometa4-abstract-preflight OK w=$W n=$N metadata_bytes_per_code=0 block=4 abstract_lut_bytes=94206 ballot_runtime_loads=0 build_smoke=$RUN_BUILD_SMOKE" >&2
