...
# - p>1 both main and blocked outputs are destination-pull: no identity memcpy,
#   no blocked memset, no modular CAS scatter, no blocked->main scatter kernel
...
FAST_SHARD_ADDRESS8=1 MAIN_MATE_CACHE=1 MAIN_PULL=1 BLOCK_PULL=1 PTXAS_VERBOSE=1 \
bash "$ONEESAN_ROOT/scripts/build/b300-hbm32.sh"

echo "=== B300 x8 full-pull throughput run ===" >&2
