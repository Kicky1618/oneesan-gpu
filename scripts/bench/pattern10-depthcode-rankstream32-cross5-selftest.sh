...
BIN="${BIN:-$ONEESAN_BUILD_DIR/pattern10_depthcode_rankstream32_cross5_selftest_w${W}_pm${PM_ACCUM}_${DECODE_LOAD}}"
mkdir -p "$(dirname "$BIN")"
...
echo "pattern10-depthcode-rankstream32-cross5-selftest OK W=$W pm_accum=$PM_ACCUM decode_load=$DECODE_LOAD rankstream32=1" >&2
