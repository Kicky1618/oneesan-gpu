...
mode=int(e['mode']); pair_bytes=int(ebytes)
if mode<1 or mode>5 or pair_bytes>=13688: raise SystemExit('invalid physical candidate')
motzkin_bytes=6960
legacy_three=20648
three_bytes=pair_bytes+motzkin_bytes
...
print(f'physical_consensus_choose_primitive_bytes={pair_bytes}')
print(f'physical_consensus_choose_primitive_saved_bytes={13688-pair_bytes}')
print(f'physical_consensus_motzkin_unmodified_bytes={motzkin_bytes}')
print(f'physical_consensus_three_table_bytes={three_bytes}')
print(f'physical_consensus_three_table_saved_bytes={legacy_three-three_bytes}')
...
print('physical_consensus_legacy_symbol_retained=0')
if ready:
