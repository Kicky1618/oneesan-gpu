...
cat "$FINAL_ENV"
echo "b300-nextgen-hybrid8-nextself-staged-calibrate OK validated=$VALIDATED threshold=$THRESHOLD final_rows=$B300_HYBRID8_NEXTSELF_ROWS winner_env=$FINAL_ENV" >&2
