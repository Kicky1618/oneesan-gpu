...
PREFIX="${PREFIX:-$ONEESAN_ROOT/work/b300_depthcode_rankchunk32_rankmask_profile_n${N}_${TRANSPOSE_MODE}_${RANKSTREAM_LUT_LOAD}}"
BIN="${BIN:-$ONEESAN_BUILD_DIR/b300_depthcode_rankchunk32_rankmask_profile_n${N}}"
...
echo "=== build rankchunk32 real-traffic rankmask profiler ===" >&2
...
echo "=== run one real production-shaped residue with profiling enabled ===" >&2
