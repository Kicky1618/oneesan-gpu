...
grep -Fq 'abstract_states=7060' <<<"$out"
grep -Fq 'abstract_depths=91780' <<<"$out"
grep -Fq 'universal_selected_sources=19273' <<<"$out"
grep -Fq 'max_source_local=1000' <<<"$out"
grep -Fq 'test_source_base=29113' <<<"$out"
grep -Fq 'max_absolute_source=30113' <<<"$out"
grep -Fq 'pack_mismatch=0' <<<"$out"
