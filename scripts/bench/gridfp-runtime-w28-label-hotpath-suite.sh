...
if [[ "$RUN_PREFIX_CARRY" == 0 && "$RUN_OWNER_LOCAL_CARRY" == 0 &&
      ...
      "$RUN_CHOOSE_SYM_U32" == 0 && "$RUN_SUPPORT13_TABLE" == 0 &&
      "$RUN_TURN_LOCAL_CARRY" == 0 && "$RUN_TURN_TREE" == 0 &&
