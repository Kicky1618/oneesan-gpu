...
for name in RUN_PREFIX_CARRY RUN_OWNER_LOCAL_CARRY RUN_OWNER_COMPACT RUN_OWNER_TREE RUN_ADJACENT_SUPPORT RUN_PLAN_SHARED RUN_MATERIALIZE_LAST_R RUN_MATERIALIZE_PACKED RUN_PRIMITIVE_RANK_PACKED RUN_PRIMITIVE1_TABLE RUN_SUPPORT13_TABLE RUN_TURN_LOCAL_CARRY RUN_TURN_TREE RUN_TURN_NONN; do
  value="${!name}"
