...
lines.insert(i+2,'  -DP10DC_ORBITCTA_FLAT_DYNAMIC_PIPE2_PRODUCER_PRECTX_WARPCOOP="$PRODUCER_PRECTX_WARPCOOP" \\\n')
src=''.join(lines)
...
line=line[:q]+' pipe2_producer_warp=1 pipe2_producer_prectx_warpcoop=$PRODUCER_PRECTX_WARPCOOP'+line[q:]
