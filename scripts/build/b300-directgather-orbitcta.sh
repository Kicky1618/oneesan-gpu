...
for x in WINDOW4 DIRECTGATHER64 DIRECTGATHER_SPARSE64 PAIR_MLP CPASYNC_PAIR PRECTX_FORWARD PRECTX_REVERSE PRECTX_COMPACT FORCE7 PM_ACCUM PTXAS_VERBOSE; do
