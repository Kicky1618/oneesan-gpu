...
for x in WINDOW4 DIRECTGATHER64 DIRECTGATHER_SPARSE64 DIRECTGATHER_SORT_RANKS PAIR_MLP CPASYNC_PAIR QUAD_MLP QUAD_OVERLAP_LOCAL QUAD_SPARSE_DESC_MLP PRECTX_FORWARD PRECTX_REVERSE PRECTX_COMPACT PRECTX_FLAT_BID PRECTX_FLAT_BID_FUSED PRECTX_WARPCOOP ORBITCTA_FLAT FORCE7 PM_ACCUM PTXAS_VERBOSE; do
