...
SRC="$(repo_path "src/cuda/gridfp/probes/ramstream32_cpu_low_domain_worker_locality_plan.cu")"
OUT="$(build_path "${OUT:-ramstream32_cpu_low_domain_worker_locality_plan_n${N}}")"
