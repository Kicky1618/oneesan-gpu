...
SRC="$(repo_path "src/cuda/gridfp/oneesan_cuda_gridfp_ramstream32_factorized_hybrid_sparse.cu")"
OUT="$(build_path "${OUT:-oneesan_cuda_gridfp_ramstream32_factorized_hybrid_sparse_n${N}}")"
