...
SRC="$(repo_path "src/cuda/b300/oneesan_cuda_gridfp_b300_hbm32_factorized_maskshard_opt_sparse.cu")"
OUT="$(build_path "${OUT:-oneesan_cuda_gridfp_b300_hbm32_factorized_maskshard_opt_sparse_n${N}}")"
...
echo "  plan: $OUT $N 4294967291 8 256 --plan-only 16 4 512"
echo "  run : $OUT $N 4294967291 8 256 run 16 4 512"
