...
__device__ __forceinline__ ShardAddress8 shard_address8_hi32_u32_main_w28_g8(Code g){std::uint32_t o=shard_hi32_seed_main(g);return shard_addr_finish_u32(g,o,shard_addr_base_main_u32(o),970298072u,11u);}
__device__ __forceinline__ ShardAddress8 shard_address8_hi32_u32_block_w28_g8(Code g){std::uint32_t o=shard_hi32_seed_block(g);return shard_addr_finish_u32(g,o,shard_addr_base_block_u32(o),3992036288u,3u);}
