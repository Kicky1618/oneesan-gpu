...
OUT="${OUT:-oneesan_cuda_gridfp_b300_directgather_colilp${COL_ILP}_pair${PAIR_MLP}_cpa${CPASYNC_PAIR}_dg64${DIRECTGATHER64}_n${N}}"
...
for x in PM_ACCUM DEPTHMAJOR FORCE7 MLP_WINDOW4 PAIR_MLP CPASYNC_PAIR PREFETCH_NEXT DIRECTGATHER64 PTXAS_VERBOSE; do
