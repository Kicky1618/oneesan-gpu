...
for x in PM_ACCUM DEPTHMAJOR FORCE7 MLP_WINDOW4 PAIR_MLP QUAD_MLP CPASYNC_PAIR CPASYNC_LOCAL_PAIR CPASYNC_OVERLAP_LOCAL_PAIR CPASYNC_OVERLAP_LOCAL_PIPE2 OVERLAP_LOCAL_CG SORTED PRECTX_FORWARD PRECTX_REVERSE PRECTX_COMPACT PREFETCH_NEXT DIRECTGATHER64 DIRECTGATHER_SPARSE64 HIGH_PLAN_PROFILE PTXAS_VERBOSE; do
