...
PAIR_MLP="${PAIR_MLP:-0}"; QUAD_MLP="${QUAD_MLP:-0}"; QUAD_LOCAL_DIRECT_MAX="${QUAD_LOCAL_DIRECT_MAX:-0}"; QUAD_OVERLAP_LOCAL="${QUAD_OVERLAP_LOCAL:-0}"; QUAD_SPARSE_DESC_MLP="${QUAD_SPARSE_DESC_MLP:-0}"; QUAD_OVERLAP_BYPASS_LOCAL0="${QUAD_OVERLAP_BYPASS_LOCAL0:-0}"
