...
SRC="$(repo_path "src/cuda/b300/oneesan_cuda_gridfp_b300_hbm32_factorized_direct_sparse.cu")"
OUT="$(build_path "${OUT:-oneesan_cuda_gridfp_b300_hbm32_factorized_direct_sparse_n${N}}")"
