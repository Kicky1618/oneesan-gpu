...
SRC="$(repo_path "src/cuda/gridfp/oneesan_cuda_gridfp_gpu_direct_atomicfree_multigpu_peerstreams.cu")"
OUT="$(build_path "${OUT:-oneesan_cuda_gridfp_gpu_direct_atomicfree_multigpu_peerstreams_n${N}}")"
