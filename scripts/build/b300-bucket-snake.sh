...
case "$TRANSPOSE_MODE" in
  sync) SRC_REL="src/cuda/b300/oneesan_cuda_gridfp_b300_bucket_snake_atomic.cu" ;;
  events) SRC_REL="src/cuda/b300/oneesan_cuda_gridfp_b300_bucket_snake_atomic_events.cu" ;;
...
OUT="$(build_path "${OUT:-oneesan_cuda_gridfp_b300_bucket_snake_atomic${SUFFIX}_n${N}}")"
