...
for x in RANKCHUNK32_ONESHFL RANKCHUNK32_FUSED16 RANKCHUNK32_BYTEPACK RANKCHUNK32_ALIGN32 RANKCHUNK32_BLOCK64 RANKDELTA8_ALIGN32 RANKDELTA8_FUSED13 RANKFORMULA_SPARSE_BASE RANKFORMULA_RAWCODE RANKFORMULA_INLINE_CROSS RANKFORMULA_BASE_DELTA PM_ACCUM TERNARY_KEY4 PTXAS_VERBOSE; do
  v="${!x}"
...
echo "built $OUT (closure=pattern10-depthcode sidecar_bytes_per_orbit=0 temporary_depth_bytes=0 decode=payload-masks runtime_unrank=0 high_ctx=$HIGH_CTX decode_load=$DEPTHCODE_DECODE_LOAD rankstream_lut_load=$RANKSTREAM_LUT_LOAD rankchunk32_oneshfl=$RANKCHUNK32_ONESHFL rankchunk32_fused16=$RANKCHUNK32_FUSED16 rankchunk32_bytepack=$RANKCHUNK32_BYTEPACK rankchunk32_align32=$RANKCHUNK32_ALIGN32 rankchunk32_block64=$RANKCHUNK32_BLOCK64 rankdelta8_align32=$RANKDELTA8_ALIGN32 rankdelta8_fused13=$RANKDELTA8_FUSED13 rankformula_sparse_base=$RANKFORMULA_SPARSE_BASE rankformula_rawcode=$RANKFORMULA_RAWCODE rankformula_inline_cross=$RANKFORMULA_INLINE_CROSS rankformula_base_delta=$RANKFORMULA_BASE_DELTA window=graph transpose=$TRANSPOSE_MODE pm_accum=$PM_ACCUM ternary_key4=$TERNARY_KEY4 ptxas_verbose=$PTXAS_VERBOSE)"
