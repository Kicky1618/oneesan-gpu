...
case "$HIGH_CTX" in thread|resolved|resolved_delta|warp|warpstriped|warpstriped_delta|warpstriped_delta_cross5|warpstriped_delta_direct_cross5) ;; *) echo "HIGH_CTX must be thread, resolved, resolved_delta, warp, warpstriped, warpstriped_delta, warpstriped_delta_cross5, or warpstriped_delta_direct_cross5" >&2; exit 2;; esac
