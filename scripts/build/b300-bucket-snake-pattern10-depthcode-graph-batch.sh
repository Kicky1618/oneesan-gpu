...
for x in RANKCHUNK32_ONESHFL RANKCHUNK32_FUSED16 RANKCHUNK32_DIRECT3 RANKCHUNK32_DIRECTMASK RANKCHUNK32_RANKMASK_PROFILE RANKCHUNK32_BYTEPACK RANKCHUNK32_ALIGN32 RANKCHUNK32_BLOCK64 RANKDELTA8_ALIGN32 RANKDELTA8_FUSED13 RANKFORMULA_SPARSE_BASE RANKFORMULA_RAWCODE RANKFORMULA_INLINE_CROSS RANKFORMULA_BASE_DELTA RANKFORMULA_SLOTMETA RANKFORMULA_SLOTROW32 PM_ACCUM TERNARY_KEY4 PTXAS_VERBOSE; do
  v="${!x}"
