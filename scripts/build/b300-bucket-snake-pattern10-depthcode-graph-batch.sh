...
case "$RANKSTREAM_LUT_LOAD" in constant|ldg) ;; *) echo "RANKSTREAM_LUT_LOAD must be constant or ldg" >&2; exit 2;; esac
...
[[ "$RANKSTREAM_LUT_LOAD" == ldg ]] && P10DC_RANKSTREAM_LUT_LDG=1
