...
SRC="$(repo_path "src/cuda/gridfp/oneesan_cuda_gridfp_ramstream32_factorized_hybrid_inplace.cu")"
OUT="$(build_path "${OUT:-oneesan_cuda_gridfp_ramstream32_factorized_hybrid_inplace_n${N}}")"
