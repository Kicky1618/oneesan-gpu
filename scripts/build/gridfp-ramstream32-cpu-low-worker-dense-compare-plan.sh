...
SRC="$(repo_path "src/cuda/gridfp/probes/ramstream32_cpu_low_worker_dense_compare_plan.cu")"
OUT="$(build_path "${OUT:-ramstream32_cpu_low_worker_dense_compare_plan_n${N}}")"
