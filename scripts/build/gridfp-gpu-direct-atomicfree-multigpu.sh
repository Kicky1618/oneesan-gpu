...
SRC="$(repo_path "src/cuda/gridfp/oneesan_cuda_gridfp_gpu_direct_atomicfree_multigpu.cu")"
OUT="$(build_path "${OUT:-oneesan_cuda_gridfp_gpu_direct_atomicfree_multigpu_n${N}}")"
