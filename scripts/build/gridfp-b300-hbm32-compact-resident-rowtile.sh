...
SRC="$(repo_path "src/cuda/b300/oneesan_cuda_gridfp_b300_hbm32_compact_resident_rowtile.cu")"
OUT="$(build_path "${OUT:-oneesan_cuda_gridfp_b300_hbm32_compact_resident_rowtile_n${N}}")"
