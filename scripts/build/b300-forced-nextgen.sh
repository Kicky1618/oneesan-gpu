...
echo "  transform_order=production_recurrence,recurrence_ilp,recurrence_hybrid_ilp8,random_cg_l2_fetch,prefetch_l2,hybrid8_nextself,dualmask,closure_batch,register_cap"
echo "  ptxas_log=$FINAL_ERR"
