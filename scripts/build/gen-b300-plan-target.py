...
new='requested_scratch_mib="<<target_mib<<" effective_scratch_mib="<<effective_target_mib<<" plan_target_mib="<<plan_target_mib<<" reserve_mib="<<reserve_mib<<"\\n";'
...
print(f'generated {out} from {src}: planner_target_env=GRIDFP_PLAN_TARGET_MIB scratch_target_separate=1 process_group_uses_full_scratch_target=1')
