...
echo "      python3 scripts/solve/solve_b300_exact_batch.py $N --binary $OUT"
echo "  scratch-free reachability-pruned exact (current research default):"
echo "    ONEESAN_DUAL_SHUFFLE=peer-pruned ONEESAN_DUAL_PRUNE_LAUNCH_KIB=8192 ONEESAN_DUAL_THREADS=256 \\"
echo "      python3 scripts/solve/solve_b300_exact_batch.py $N --binary $OUT"
echo "  ONEESAN_DUAL_PRUNE_LAUNCH_KIB=0 gives minimum bytes; larger values trade bytes for fewer kernels."
