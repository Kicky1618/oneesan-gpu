...
grep -Fq "ilp8_pair_cg_l2_bytes=$ILP8_PAIR_CG_L2_BYTES ilp8_block_cg_l2_bytes=$ILP8_BLOCK_CG_L2_BYTES" "$UP_OUT" || { echo 'Stage-S lost high-state L2 tuple' >&2; exit 3; }
NEXT="$ISO/stages.cu"
...
grep -Fq "high_pair=$PAIR_LOAD_POLICY high_block=$BLOCK_LOAD_POLICY high_pair_l2=$ILP8_PAIR_CG_L2_BYTES high_block_l2=$ILP8_BLOCK_CG_L2_BYTES" "$ISO/stages.transform.out" || { echo 'Stage-S transformed high-state provenance drift' >&2; exit 3; }
...
echo "  high_pair_load_policy=$PAIR_LOAD_POLICY high_block_load_policy=$BLOCK_LOAD_POLICY high_pair_cg_l2_bytes=$ILP8_PAIR_CG_L2_BYTES high_block_cg_l2_bytes=$ILP8_BLOCK_CG_L2_BYTES"
