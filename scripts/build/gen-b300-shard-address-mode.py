...
#endif
static_assert(B300_SHARD_ADDRESS_MODE>=0&&B300_SHARD_ADDRESS_MODE<=2,"B300_SHARD_ADDRESS_MODE must be 0..2");
__device__ __forceinline__ ShardAddress8 shard_address8(Code g,Code chunk){int o=0;Code c4=chunk<<2;if(g>=c4){g-=c4;o|=4;}Code c2=chunk<<1;if(g>=c2){g-=c2;o|=2;}if(g>=chunk){g-=chunk;o|=1;}return{o,g};}
...
def main() -> None:
    ...
    print(f'generated {args.out} from {args.src} shard_address_modes=0,1,2 guarded_w28_ngpu8=1')
