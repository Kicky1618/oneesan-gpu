...
case "$MODE" in
  ...
  p2p-cycle-owner-descriptorless)
    ...
    ;;
  p2p-cycle-owner-pipeline)
    SRC_REL="src/cuda/gridfp/gridfp_reduced_production_p2p_cycle_owner_descriptorless_pipeline_microprobe.cu"
    ;;
  p2p-cycle-owner-selective-pipeline)
    SRC_REL="src/cuda/gridfp/gridfp_reduced_production_p2p_cycle_owner_selective_pipeline_microprobe.cu"
    ;;
  ...
  p2p-cycle-owner-route-pipeline)
    ...
    ;;
  p2p-cycle-owner-fused-route-pipeline)
    SRC_REL="src/cuda/gridfp/gridfp_reduced_production_p2p_cycle_owner_fused_route_pipeline_microprobe.cu"
    ;;
  p2p-cycle-owner-compact-route-pipeline)
    SRC_REL="src/cuda/gridfp/gridfp_reduced_production_p2p_cycle_owner_compact_route_pipeline_microprobe.cu"
    ;;
  p2p-cycle-owner-precomputed-dst-route-pipeline)
    SRC_REL="src/cuda/gridfp/gridfp_reduced_production_p2p_cycle_owner_precomputed_dst_route_pipeline_microprobe.cu"
    ;;
  p2p-cycle-owner-support-rank-lut-pipeline)
    SRC_REL="src/cuda/gridfp/gridfp_reduced_production_p2p_cycle_owner_support_rank_lut_pipeline_microprobe.cu"
    ;;
  p2p-cycle-owner-route-lut-pipeline)
    SRC_REL="src/cuda/gridfp/gridfp_reduced_production_p2p_cycle_owner_route_lut_pipeline_microprobe.cu"
    ;;
  p2p-cycle-owner-b300-feed-pipeline)
    SRC_REL="src/cuda/gridfp/gridfp_reduced_production_p2p_cycle_owner_b300_feed_pipeline_microprobe.cu"
    ;;
  p2p-scratch-plan)
  ...
  support-rank)
    ...
    ;;
  *)
    echo "invalid MODE=$MODE (forward|reverse|register|persistent|dense|edge|grouped|inplace|cycle|shift-cycle|turn|owner-component|owner-lean|owner-support|p2p-cycle|p2p-token-cycle|p2p-token-plan|p2p-pair-queue|p2p-scratch-cycle|p2p-scratch-full|p2p-scratch-owner|p2p-persistent-segment|p2p-persistent-pipeline|p2p-host-persistent-list|p2p-host-persistent-descriptorless|p2p-cycle-owner-descriptorless|p2p-cycle-owner-pipeline|p2p-cycle-owner-selective-pipeline|p2p-cycle-owner-precomputed-pipeline|p2p-cycle-owner-route-pipeline|p2p-cycle-owner-fused-route-pipeline|p2p-cycle-owner-compact-route-pipeline|p2p-cycle-owner-precomputed-dst-route-pipeline|p2p-cycle-owner-support-rank-lut-pipeline|p2p-cycle-owner-route-lut-pipeline|p2p-cycle-owner-b300-feed-pipeline|p2p-scratch-plan|p2p-cycle-batch-plan|p2p-traffic|p2p-traffic-matrix|p2p-capability|p2p-mailbox|p2p-owner-lut|support-rank)" >&2
    exit 2
    ;;
esac
