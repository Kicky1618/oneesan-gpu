...
for x in PAIR_MLP CPASYNC_PAIR CPASYNC_LOCAL_PAIR CPASYNC_OVERLAP_LOCAL_PAIR CPASYNC_OVERLAP_LOCAL_PIPE2 SORTED PRECTX_FORWARD PRECTX_REVERSE FORCE7 MLP_WINDOW4 PREFETCH_NEXT DIRECTGATHER64 DIRECTGATHER_SPARSE64; do
