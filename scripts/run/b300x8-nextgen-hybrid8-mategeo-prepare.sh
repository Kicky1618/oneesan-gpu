...
cat "$PREPARE_ENV"
echo "B300 MATEGEO PREPARED self=w${B300_STAGEI_PREPARED_SELF_WIDTH}d${B300_STAGEI_PREPARED_SELF_DISTANCE} mate=w${B300_STAGEI_PREPARED_MATE_WIDTH}d${B300_STAGEI_PREPARED_MATE_DISTANCE} self_evict=$SELF_EVICT mate_evict=$MATE_EVICT env=$PREPARE_ENV" >&2
