...
CFG_TAG="${SPARSE_TAG}_i${ORBITCTA_COL_ILP}_pair${PAIR_MLP}_cpa${CPASYNC_PAIR}_pm${PM_ACCUM}"
...
for x in REBUILD PREFLIGHT DIRECTGATHER_SPARSE64 PAIR_MLP CPASYNC_PAIR PM_ACCUM RANKFORMULA_MLP_WINDOW4; do
