...
GRIDFP_RUNTIME_AB_ENV=(
  ...
  RUNTIME_TURN_DIRECT_HIGH_COMPRESS_STEP=1
  RUNTIME_TURN_DIRECT_LOW_COMPRESS_STEP=1
  RUNTIME_TURN_DIRECT_HIGH_COMPRESS_INVERSE=1
  RUNTIME_TURN_DIRECT_LOW_EXPAND_INVERSE=1
