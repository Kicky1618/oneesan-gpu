...
#endif
#include "../gridfp/ramstream32_bucket_orbit_closure_pattern10_depthcode_graph.cuh"
...
#define BucketOnePassGraphs BucketPattern10DepthCodeGraphs
#define bucket_onepass_graph_sync_devices bucket_pattern10_depthcode_graph_sync_devices
