...
static void process_group(DeviceCtx&c,int W,const WindowPlan&wp,const PreparedGroup&pg,int threads,size_t target,bool fuse){
...
int main(int argc,char**argv){
    ...
    int fuseMode=3;if(const char*e=std::getenv("GRIDFP_FUSE_MODE"))fuseMode=std::atoi(e);std::cerr<<"fuse_mode="<<fuseMode<<" (1=upper,2=lower,3=both)\n";
