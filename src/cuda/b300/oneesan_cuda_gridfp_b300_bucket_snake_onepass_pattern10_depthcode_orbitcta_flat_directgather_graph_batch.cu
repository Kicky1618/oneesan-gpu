...
#include "../gridfp/ramstream32_bucket_orbit_closure_pattern10_depthcode_orbitcta_flat_delta_direct_affine_rankformula_nometa4_abstract_graph.cuh"
...
#if P10DC_RANKFORMULA_DIRECTGATHER64
#if P10DC_RANKFORMULA_DIRECTGATHER_SPARSE64
using P10DCFlatOrbitSelectedFusedDeviceTables = BucketFusedDirectHighRowsRankFormulaNometa4DirectGatherSparse64Tables;
#else
using P10DCFlatOrbitSelectedFusedDeviceTables = BucketFusedDirectHighRowsRankFormulaNometa4DirectGather64Tables;
#endif
#else
using P10DCFlatOrbitSelectedFusedDeviceTables = BucketFusedDirectHighRowsRankFormulaNometa4DirectMapDepthMajorTables;
#endif
...
#define P10DC_FLAT_ORBIT_PRECTX_BYTES sizeof(P10DCHighClosurePreCtx)
#endif
#define BSN_GRAPH_BATCH_EXTRA_METADATA_BYTES(borbit,reverse) \
    (P10DC_FLAT_ORBIT_PRECTX_BYTES * \
...
#else
#define BucketFusedDeviceTables P10DCFlatOrbitSelectedFusedDeviceTables
#endif
...
#define BucketOnePassGraphs BucketPattern10DepthCodeFlatOrbitCtaDirectAffineRankFormulaNometa4AbstractGraphs
#define bucket_onepass_graph_sync_devices bucket_pattern10_depthcode_flat_orbitcta_rankformula_nometa4_abstract_graph_sync_devices
