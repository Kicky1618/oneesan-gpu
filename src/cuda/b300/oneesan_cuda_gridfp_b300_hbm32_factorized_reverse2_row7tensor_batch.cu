...
int main(int argc,char**argv){
    ...
    for(size_t ri=0;ri<mods.size();++ri){Count mod=mods[ri];
        ...
        if(ng!=1&&prefixK>1&&!((requestDirect5&&prefixK==5)||(requestDirect6&&prefixK==6)||(requestDirect7&&prefixK==7))){std::cerr<<"bounded prefix prototype currently requires NGPU=1 except direct row5/6/7\n";return 31;}
        if(prefixK==1){
