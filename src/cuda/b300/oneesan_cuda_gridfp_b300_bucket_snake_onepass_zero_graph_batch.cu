...
#include "../gridfp/ramstream32_bucket_orbit_closure_zero_graph.cuh"
...
#define BucketOnePassGraphs BucketClosureZeroGraphs
#define bucket_onepass_graph_sync_devices bucket_closure_zero_graph_sync_devices
