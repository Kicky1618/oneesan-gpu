// v0.25 experiment: v0.24 LOW closure row-depth plus threshold-29 HIGH row packing.
// The only change relative to v0.24 is the HIGH closure packing policy:
// dense LOW stride < 16 becomes < 29.  LOW closure pruning remains enabled.
...
int main(int argc, char** argv) {
    ...
    std::cerr
        << "backend_alias=b300-factorized-maskshard-v0.25-highrowpack29-rowdepthexact-exacttasks-highclosureexact-lowclosurerowdepth-batch"
        ...
        << " low_closure_cols=1 low_closure_row_depth=1"
