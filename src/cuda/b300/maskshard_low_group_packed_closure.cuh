...
#error "packed LOW closure requires MASKSHARD_LOW_GROUP_PACKED_CONFIG"
#endif
#ifndef MASKSHARD_LOW_CLOSURE_ROW_DEPTH_COMPACT
#error "packed LOW closure requires exact row-depth closure tasks"
#endif

#include "maskshard_low_group_packed_config.cuh"

// v0.38 copy of the v0.26 exact LOW closure kernel whose only mutable
// per-group state comes from D_MS_LOW_GROUP_PACKED.  Immutable descriptor,
// rank, and row-depth tables continue to use their existing global symbols.
__global__ void maskshard_main_lowdesc_closure_rowdepth_packed_inplace_kernel(
...
#define maskshard_main_lowdesc_closure_inplace_kernel \
        maskshard_main_lowdesc_closure_rowdepth_packed_inplace_kernel
