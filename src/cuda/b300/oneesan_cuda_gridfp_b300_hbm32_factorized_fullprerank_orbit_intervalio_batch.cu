...
static std::vector<PeerInterval> make_peer_intervals(const GroupSpec&s,Code chunk,int ng,bool& use_interval){
    #ifndef GRIDFP_MIN_AVG_INTERVAL_ELEMS
#define GRIDFP_MIN_AVG_INTERVAL_ELEMS 65536
#endif
    constexpr Code MIN_AVG_INTERVAL_ELEMS = GRIDFP_MIN_AVG_INTERVAL_ELEMS;
