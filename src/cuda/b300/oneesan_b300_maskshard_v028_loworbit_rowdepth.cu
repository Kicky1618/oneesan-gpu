// v0.28 experiment: v0.27 exact LOW closure launch plus exact row-depth
// pruning inside the BLOCKED-domain LOW orbit body.  The source set and host
// launch geometry are unchanged from v0.27; this isolates the body predicate.
...
int main(int argc, char** argv) {
    ...
    std::cerr
        << "backend_alias=b300-factorized-maskshard-v0.28-loworbitrowdepth-batch"
