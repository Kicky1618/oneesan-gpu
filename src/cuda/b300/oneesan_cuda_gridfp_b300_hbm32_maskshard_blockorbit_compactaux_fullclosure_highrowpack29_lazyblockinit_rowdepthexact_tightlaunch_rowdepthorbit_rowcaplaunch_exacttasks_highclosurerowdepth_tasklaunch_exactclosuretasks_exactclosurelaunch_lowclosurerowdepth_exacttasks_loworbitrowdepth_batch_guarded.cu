// v0.28 experiment: v0.26 exact LOW closure tasks plus exact row-depth pruning
// of BLOCKED-domain LOW orbit bodies.  HIGH behavior and LOW closure mapping are
// unchanged; only structurally unreachable LOW orbit triples are skipped before
// descriptor/aux/state loads.
...
int main(int argc, char** argv) {
    ...
    std::cerr
        << "backend_alias=b300-factorized-maskshard-v0.28-highrowpack29-rowdepthexact-exacttasks-highclosureexact-lowclosureexacttasks-loworbitrowdepth-batch"
