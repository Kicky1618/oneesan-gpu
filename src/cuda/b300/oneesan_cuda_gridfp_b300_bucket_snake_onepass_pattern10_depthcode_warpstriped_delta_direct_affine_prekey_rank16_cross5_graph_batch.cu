...
#endif
#include "../gridfp/ramstream32_bucket_orbit_closure_pattern10_depthcode_warpstriped_delta_direct_affine_prekey_rank16_cross5_graph.cuh"
...
#define BucketFusedDeviceTables BucketFusedDirectHighRowsPrekeyRank16Tables
...
#define BucketOnePassGraphs BucketPattern10DepthCodeWarpStripedDeltaDirectAffinePrekeyRank16Cross5Graphs
#define bucket_onepass_graph_sync_devices bucket_pattern10_depthcode_warpstriped_delta_direct_affine_prekey_rank16_cross5_graph_sync_devices
