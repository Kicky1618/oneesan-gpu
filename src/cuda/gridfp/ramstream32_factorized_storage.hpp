...
// For each fixed height, all legal codes are ordered by
// (occupancy mask, rank within that mask).  This keeps each occupancy class
// contiguous in authoritative RAM while preserving the exact state bijection.
