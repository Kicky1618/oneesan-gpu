...
#include "ramstream32_bucket_closure_cross5_rankchunk32_basepair64.cuh"

#ifdef P10DC_CROSS5_ORDINARY_LUT_DEFINED
#error "rankchunk32 basepair64 variant must not pull in the ordinary CROSS5 device LUT"
#endif
...
__device__ __forceinline__ Count p10dc_direct_resolved_high_plan_sum_cross5_rankchunk32_basepair64(
...
#pragma unroll
    ...
    if (c.cross_depth) {
#if GPU_DIRECT_PM_ACCUM
        sum += p10dc_resolved_low_preimages_cross5_rankchunk32_basepair64_fixed(
