...
#include "ramstream32_bucket_closure_cross5_rankformula_nometa4_abstract_direct64.cuh"

#ifdef P10DC_CROSS5_ORDINARY_LUT_DEFINED
#error "rankformula nometa4 abstract direct64 variant must not pull in ordinary CROSS5 device LUT"
#endif
...
__device__ __forceinline__ Count p10dc_direct_resolved_high_plan_sum_cross5_rankformula_nometa4_abstract_direct64(
