...
#error "rankformula CROSS5 variant must not pull in the ordinary CROSS5 device LUT"
#endif
...
__device__ __forceinline__ Count p10dc_direct_resolved_high_plan_sum_cross5_rankformula(
...
#pragma unroll
    ...
    if (c.cross_depth) {
#if GPU_DIRECT_PM_ACCUM
        sum += p10dc_resolved_low_preimages_cross5_rankformula_fixed(
