...
#include "ramstream32_bucket_closure_pattern10_depthcode_delta_direct_affine_prekey_rankstream.cuh"
...
#define p10dc_resolved_high_plan_sum p10dc_direct_resolved_high_plan_sum_cross5_prekey_rankstream
#define bucket_high_orbit_closure_pattern10_depthcode_warpstriped_kernel \
    bucket_high_orbit_closure_pattern10_depthcode_warpstriped_delta_direct_affine_prekey_rankstream_cross5_kernel
#define bucket_reverse_high_pattern10_depthcode_warpstriped_kernel \
    bucket_reverse_high_pattern10_depthcode_warpstriped_delta_direct_affine_prekey_rankstream_cross5_kernel
